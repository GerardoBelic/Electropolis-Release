...
namespace SlimUI.ModernMenu{
	public class UISettingsManager : MonoBehaviour {
		...
		public GameObject pixeleffectstext; 
		...
		public void  Start (){
			...
			if (!PlayerPrefs.HasKey("PixelEffects"))
			{
				PlayerPrefs.SetInt("PixelEffects", 0);
			}
			if (!PlayerPrefs.HasKey("Rain"))
			{
		...
		public void PixelEffects(){
			if(PlayerPrefs.GetInt("PixelEffects")==0){
				PlayerPrefs.SetInt("PixelEffects",1);
				pixeleffectstext.GetComponent<TMP_Text>().text = "on";
			}
			else if(PlayerPrefs.GetInt("PixelEffects")==1){
				PlayerPrefs.SetInt("PixelEffects",0);
				pixeleffectstext.GetComponent<TMP_Text>().text = "off";
			}
		}
		...
		public void Rain (){
			if(PlayerPrefs.GetInt("Rain")==0){
				...
				raintext.GetComponent<TMP_Text>().text = "on";
			}
			else if(PlayerPrefs.GetInt("Rain")==1){
				PlayerPrefs.SetInt("Rain",0);
				raintext.GetComponent<TMP_Text>().text = "off";
			}
		}
