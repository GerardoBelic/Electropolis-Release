...
public class CommerceBuilding : Building, IJobOccupation, ILeisureOccupation
{
    ...
    #region Leisure occupation

    [SerializeField] private int leisure_total_slots = 0;
    private int leisure_reserved_slots = 0;
    private HashSet<Citizen> clients_in_building = new HashSet<Citizen>();

    public bool are_leisure_places_available()
    {
        if (leisure_total_slots - leisure_reserved_slots > 0)
        {
            return true;
        }
    ...
    public void request_leisure_vacancy()
    {
        ++leisure_reserved_slots;
    }

    public void release_leisure_vacancy()
    {
        --leisure_reserved_slots;
    }

    public void start_amusement(Citizen citizen)
    {
        clients_in_building.Add(citizen);
    }

    public void stop_amusement(Citizen citizen)
    {
        clients_in_building.Remove(citizen);
    }
