...
public class Walk_Teleporter : MonoBehaviour
{

    /// Spawn point when the NPC starts to walk
    ...
    [SerializeField] private Drive_Teleporter other_teleporter;
    ...
    void Awake()
    {
        ...
        /// Check if we setted the drive teleporter
